...
Project Start Date: Apr-07-2026

## Neural Observability and Organization Invariants - Complete Chronology

**Repository:** [https://github.com/urmt/SGP-Tribe3](https://github.com/urmt/SGP-Tribe3) This Report was **Generated:** May-08-2026 **Total Experiments:** 115 phases
...
- **Fixed hyperparameters** (random\_state=42, n\_estimators=200)
...
```
empirical\\\_analysis/neural\\\_networks/    
├── phase10a\\\_training\\\_dynamics/    
├── phase11a\\\_spectral/    
├── phase66\\\_information\\\_geometry/    
├── ...    
├── phase83\\\_real\\\_world\\\_invariant\\\_test/    
├── phase100\\\_real\\\_data\\\_rebuild/    
├── phase112\\\_persistent\\\_acquisition/   \\\# Contains 5 real EEG subjects    
├── phase113\\\_real\\\_loso/    
├── phase114\\\_causal\\\_destruction/    
└── phase115\\\_hierarchical\\\_surrogates/
```
