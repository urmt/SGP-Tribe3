...
plt.grid(True)
plt.legend()
plt.savefig("phase252_script7_order_parameter.png", dpi=200, bbox_inches="tight")
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig("phase252_script7_susceptibility.png", dpi=200, bbox_inches="tight")
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig("phase252_script7_binder.png", dpi=200, bbox_inches="tight")
plt.close()
...
plt.title(f"Finite-Size Scaling\ngamma={gamma:.3f}, R2={r2:.4f}")
plt.grid(True)
plt.savefig("phase252_script7_fss.png", dpi=200, bbox_inches="tight")
plt.close()
...
plt.grid(True)
plt.savefig("phase252_script7_binder_min_scaling.png", dpi=200, bbox_inches="tight")
plt.close()
...
print(f"\nFinite-size scaling fit: gamma={gamma:.4f}, R2={r2:.4f}")
print("\nDONE")