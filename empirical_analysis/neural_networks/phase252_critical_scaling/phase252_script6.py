...
plt.grid(True)
plt.legend()
plt.savefig("phase252_script6_order_parameter.png", dpi=200, bbox_inches="tight")
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig("phase252_script6_susceptibility.png", dpi=200, bbox_inches="tight")
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig("phase252_script6_binder.png", dpi=200, bbox_inches="tight")
plt.close()
...
plt.grid(True)
plt.savefig("phase252_script6_fss.png", dpi=200, bbox_inches="tight")
plt.close()
...
print("================================================")
for i, N in enumerate(N_VALUES):
    print(f"N={N} | peak chi={peak_chi_values[i]:.4f}")
